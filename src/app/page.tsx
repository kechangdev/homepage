...
export default function Home() {
    ...
    const services = [
        {
            ...
            image: "./f6669cd6-cc9d-4dca-aa17-1fd89627bc72.jpg",
        ...
        },
        {
            ...
            image: "./d0716f12-4d93-4c21-abdd-16bb55ef8ac4d0716f12-4d93-4c21-abdd-16bb55ef8ac4.jpg",
        ...
        },
        {
            ...
            image: "./e3666fa0-3be1-4625-83f1-415469d24212.jpg",
        ...
        },
        {
            ...
            image: "./61bc68f6-b3cd-4e1a-9cde-5f5f72a44f79.jpg",
    ...
    const calculateBlockSize = () => {
        ...
        const newSize = Math.min(windowWidth / (numberOfServices + 1), 300);
        ...
        <>
            ...
            <motion.div
                ...
                style={{
                    ...
                    boxShadow: '0 0 10px rgba(191, 27, 21, 0.5)',
                }}
            />
            ...
            <section
                ...
                <motion.div
                    ...
                    className="absolute inset-0 bg-[url('/background.jpg')] bg-cover bg-center"
                    style={{ opacity: 0.4 }}
                />
